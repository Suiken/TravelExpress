...
<head>
    ...
    <title>Connexion | BlaBlaCar</title>

    <link rel="canonical" href="https://www.blablacar.fr/identification">

    <link rel="alternate" href="https://www.blablacar.fr/identification" hreflang="fr-FR">
    ...
    <link rel="image_src" href="https://d1ovtcjitiy70m.cloudfront.net/vi-1/images/logo.gif">
        ...
        <!--[if lt IE 9]>
        <script src="/v-1465314200/assets/static/html5shiv.min.js"></script>
        <![endif]-->
    ...
    <!--[if lt IE 9]>
        ...
        <div class="page">
            ...
            <div id="maincontent" class="container" role="main">
                ...
                <div class="span6 offset3 margin-top register-container">
                    <div class="box-register form-register">
                        <h1 class="title-lv1 margin-vertical size28 align-center">Connexion</h1>
                        <div class="form-register-container">
                            
                            <form id="login-form" action="checklogin" method="POST" novalidate="">
                                ...
                                <div class="form-action">
                                    <button type="submit" name="_submit" class="btn-validation btn-large full-width apply-btn-loader">
                                        <img class="img-loader hide" src="res/ajax-loader-blue.gif" alt="" aria-hidden="true">
                                        Connexion
                                    </button>
                                </div>
